...
static uint64_t mp[5] = { 0x2F00000000000000,0xFFFFFFFFFEFFFFFC,0xFFFFFFFFFFFFFFFF,0xFFFFFFFFFFFFFFFF,0x00FFFFFFFFFFFFFF };//p << 48, p*m = p* 2^48
static uint64_t r = { 4294968273 };//2^256 - p
...
void add_u256_mod(uint64_t* a, uint64_t* b, uint64_t* c)
{
	uint64_t result;
	uint64_t carry;
...
void mul_u256_mod(uint64_t* a, uint64_t* b, uint64_t* c)
{
	uint64_t z[8];
	uint64_t A[5];
	uint64_t B[5];
